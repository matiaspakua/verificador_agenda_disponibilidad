...
/**
 * Clase para crear lista de d�as para la jornada laboral. Lista de enteros
 * [1..30 � 31] dependiendo del mes actual.
 *
 * @author matias
 */
public class JornadaDiasDelMes extends Jornada implements Cloneable {
     ...
     * para un mes, usando como par�metro una lista de d�as [1..30 o 31] dependiendo
     * del mes actual.
     */
    @Override
