...
public class ServicioVerificadorDisponibilidadTest {
    ...
    public void SetUp() throws CloneNotSupportedException {
        ...
        // Margarita puede trabajar los Mi�rcoles y los fines de semana, una
        // disponibilidad
        // combinada de d�a puntual y fin de semana
        ...
        // Jazm�n tiene disponibilidad de Lunes a Viernes, que se considera la
        ...
        // Fanny y Benicio trabajan todos los jueves y los d�as 2, 3, 5, 7 y
        // del 20 al 28, es decir una combinaci�n de d�as puntuales y d�as del mes
        Empleado fanny = new Empleado("fanny");
        Empleado benicio = new Empleado("benicio");

        // primero agregamos la jornada de d�a puntual: lunes, martes, etc.
    ...
    public void TC01_buscarDisponibilidadParaCubrirAsignacion_02_02_2019_Test() {
        ...
        asignacionACubrir.asignarDescripcion("Ejemplo de asignaci�n a cubrir.");
    ...
    public void TC04_buscarDisponibilidadParaCubrirAsignacion_06_09_2021_Test() throws CloneNotSupportedException {
        ...
        jornadaDiasDelMesDisponible.asignarAutorizacion(
                new Autorizacion(" si necesit�s el Mi�rcoles 06/09 puedo venir (no tengo clases)", seTrabaja));
    ...
    public void TC06_buscarDisponibilidadParaCubrirAsignacion_08_09_2021_Test() throws CloneNotSupportedException {
        ...
        jornadaDiasDelMesDisponible.asignarAutorizacion(new Autorizacion(
                "Asado. Comentario del gerente de sucursal: Chicos no podemos cerrar la sucursal, habl�moslo",
                seTrabaja));
        ...
        // los unicos 3 que necesitan la autorizacion para esos d�as laborales.
